...
#define MGMT_OP_LE_START_SCAN			0xE100

#define MGMT_OP_LE_STOP_SCAN			0xE101

#define MGMT_OP_LE_SETUP_SCAN_PARAMS	0xE102
struct mgmt_cp_le_setup_scan_params {
	__u16 scan_interval;
	__u16 scan_window;
/* FUJITSU:2013-07-10 FJ BLE add start */
	__u8  filter_policy;
/* FUJITSU:2013-07-10 FJ BLE add end */
} __packed;
