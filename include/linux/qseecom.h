...
struct qseecom_send_cmd_oem_req {
	unsigned int	cmd_id; 	/* in */
	void			*data_buf;	/* in/out */
	unsigned int	data_len;	/* in/out */
	unsigned long	param1; 	/* in */
	void			*param2;	/* in */
	void			*param3;	/* out */		/* FUJITSU:2013-05-14 sddl_encrypt add */
};
...
/* FUJITSU:2013-01-18 sddl_encrypt add start */
#define QSEECOM_IOCTL_SEND_OEM_CMD_REQ \
	_IOWR(QSEECOM_IOC_MAGIC, 50, struct qseecom_send_cmd_oem_req)
/* FUJITSU:2013-01-18 sddl_encrypt add end */
