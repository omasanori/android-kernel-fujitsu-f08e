...
enum {
	...
	/* FUJITSU:2013-01-19 FJ_BATTERY add start */
	POWER_SUPPLY_STATUS_MAX,
	/* FUJITSU:2013-01-19 FJ_BATTERY add end */
};
...
enum power_supply_property {
	...
	/* FUJITSU:2012-11-20 FJ_CHARGER add end   */
	/* FUJITSU:2013-01-23 FJ_CHARGER add start */
	POWER_SUPPLY_PROP_TEMP_CHARGE,
	POWER_SUPPLY_PROP_TEMP_CENTER,
	/* FUJITSU:2013-01-23 FJ_CHARGER add end   */
	/* FUJITSU:2013-03-28 FJ_CHARGER add start */
	POWER_SUPPLY_PROP_TEMP_SENSOR,
	/* FUJITSU:2013-03-28 FJ_CHARGER add end */
