...
/* FUJITSU:2013-01-28 FingerPrintSensor_FPC1080 add-S */
	F_GSBI_QUP(12000000, pll8, 4, 1,  8),
...
static struct clk_freq_tbl clk_tbl_sdc[] = {
	...
	F_SDC( 23530000, pll0,  2, 1,   17),
	F_SDC( 24000000, pll8,  4, 1,   4),
	F_SDC( 47060000, pll0,  1, 1,   17),
	F_SDC( 48000000, pll8,  4, 1,   2),
	F_SDC( 64000000, pll8,  3, 1,   2),
	F_SDC( 88888888, pll0,  1, 1,   9),
...
/* FUJITSU:2013_01_31 mod camera start */
	F_CAM( 24727272, pll8, 4, 17,  66),
	F_CAM( 25600000, pll8, 1, 1,  15),
/* FUJITSU:2013_01_31 mod camera end */
...
static struct clk_lookup msm_clocks_8064[] = {
...
#else
	CLK_LOOKUP("core_clk",		gsbi1_uart_clk.c,	""),					/* FUJITSU:2012-11-16 gsbisetting mod */
#endif
	CLK_LOOKUP("core_clk",		gsbi2_uart_clk.c,	"msm_serial_hsl.2"),	/* FUJITSU:2012-11-16 gsbisetting mod */
	CLK_LOOKUP("core_clk",		gsbi3_uart_clk.c,	"msm_serial_hsl.3"),	/* FUJITSU:2012-11-16 gsbisetting mod */
#ifdef CONFIG_MACH_LGE
	CLK_LOOKUP("core_clk",		gsbi4_uart_clk.c,	"msm_serial_hsl.0"),
#else
	CLK_LOOKUP("core_clk",		gsbi4_uart_clk.c,	""),					/* FUJITSU:2013-03-18 gsbisetting mod */
#endif
	CLK_LOOKUP("core_clk",		gsbi5_uart_clk.c,	"msm_serial_hsl.5"),	/* FUJITSU:2012-11-16 gsbisetting mod */
	CLK_LOOKUP("core_clk",		gsbi6_uart_clk.c,	""),					/* FUJITSU:2013-04-12 gsbisetting mod */
#ifdef CONFIG_MACH_LGE
	...
	CLK_LOOKUP("core_clk",		gsbi2_qup_clk.c,	"qup_i2c.2"),	/* FUJITSU:2012-11-16 gsbisetting mod */
	CLK_LOOKUP("core_clk",		gsbi3_qup_clk.c,	"qup_i2c.3"),
	CLK_LOOKUP("core_clk",		gsbi4_qup_clk.c,	"spi_qsd.4"),	/* FUJITSU:2012-11-16 gsbisetting mod */
	CLK_LOOKUP("core_clk",		gsbi5_qup_clk.c,	""),			/* FUJITSU:2012-11-16 gsbisetting mod */
	CLK_LOOKUP("core_clk",		gsbi5_qup_clk.c,	"qup_i2c.5"),
	CLK_LOOKUP("core_clk",		gsbi6_qup_clk.c,	""),
	CLK_LOOKUP("core_clk",		gsbi7_qup_clk.c,	"qup_i2c.7"),	/* FUJITSU:2012-11-16 gsbisetting mod */
...
#else
	CLK_LOOKUP("iface_clk",		gsbi1_p_clk.c,	""),			/* FUJITSU:2012-11-16 gsbisetting mod */
#endif
	CLK_LOOKUP("iface_clk",		gsbi1_p_clk.c,	"qup_i2c.0"),
	CLK_LOOKUP("iface_clk",		gsbi2_p_clk.c,	"qup_i2c.2"),	/* FUJITSU:2012-11-16 gsbisetting mod */
	CLK_LOOKUP("iface_clk",		gsbi2_p_clk.c,		"msm_serial_hsl.2"),	/* FUJITSU:2012-11-16 gsbisetting add */
	CLK_LOOKUP("iface_clk",		gsbi3_p_clk.c,		"qup_i2c.3"),
	CLK_LOOKUP("iface_clk",		gsbi3_p_clk.c,		"msm_serial_hsl.3"),	/* FUJITSU:2012-11-16 gsbisetting add */
#ifdef CONFIG_MACH_LGE
	CLK_LOOKUP("iface_clk",		gsbi4_p_clk.c,		"msm_serial_hsl.0"),
#endif
	CLK_LOOKUP("iface_clk",		gsbi4_p_clk.c,		"spi_qsd.4"),			/* FUJITSU:2012-11-16 gsbisetting mod */
/* FUJITSU:2013-03-18 gsbisetting del */
#if 0 
	CLK_LOOKUP("iface_clk",		gsbi4_p_clk.c,	"msm_serial_hs.1"),
#endif
/* FUJITSU:2013-03-18 gsbisetting del */
	CLK_LOOKUP("iface_clk",		gsbi5_p_clk.c,		"msm_serial_hsl.5"),	/* FUJITSU:2012-11-16 gsbisetting mod */
	CLK_LOOKUP("iface_clk",		gsbi5_p_clk.c,		"qup_i2c.5"),
	CLK_LOOKUP("iface_clk",		gsbi6_p_clk.c,		""),					/* FUJITSU:2013-04-12 gsbisetting mod */
#ifdef CONFIG_MACH_LGE
	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,		""),
#else
	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,	"msm_serial_hsl.0"),
#endif
	CLK_LOOKUP("iface_clk",		gsbi7_p_clk.c,		"qup_i2c.7"),	/* FUJITSU:2012-11-16 gsbisetting mod */
...
/* FUJITSU:2013_01_31 mod camera start */
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"3-001f"),
//	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"3-003c"),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"3-003c"),
/* FUJITSU:2013_01_31 mod camera end */
...
struct clock_init_data dump_clock_init_data = {
	.table = msm_clocks_8064,
	.size = ARRAY_SIZE(msm_clocks_8064),
};
/* FUJITSU:2013-01-25 gpiodump end */
