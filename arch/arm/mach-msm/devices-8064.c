...
/* FUJITSU:2013-04-30 FingerPrintSensor_FPC1080 add-S */
#include "../../../../fjfeat/FjFeatMac.h"
/* FUJITSU:2013-04-30 FingerPrintSensor_FPC1080 add-E */

/* Address of GSBI blocks */
#define MSM_GSBI1_PHYS		0x12440000
/* FUJITSU:2012-12-14 for GSBI2 I2C mod start */
//#define MSM_GSBI2_PHYS		0x13440000
#define MSM_GSBI2_PHYS		0x12480000
/* FUJITSU:2012-12-14 for GSBI2 I2C mod end */
...
static struct msm_watchdog_pdata msm_watchdog_pdata = {
	.pet_time = 10000,
/* FUJITSU:2012-11-16 watch dog bark time mod start */
#if 0
	.bark_time = 11000,
#else
	.bark_time = 15000,
#endif
/* FUJITSU:2012-11-16 watch dog bark time mod end */
	.has_secure = true,
...
#define SD_CARD_DEVICE_ID apq8064_device_sdc3.id
int check_device_id_sd(int id) {
	int ret = false;

	if (id == SD_CARD_DEVICE_ID) {
		ret = true;
	}
	return ret;
}
