...
/* FUJITSU:2013-03-26 mod start */
#if 1
		int value = gpio_get_value(mdm_drv->mdm2ap_status_gpio);
		pr_info("%s: getting MDM2AP_STATUS %d\n", __func__, value);
		if (value == 0) {
#else
		if (gpio_get_value(mdm_drv->mdm2ap_status_gpio) == 0) {
#endif
/* FUJITSU:2013-03-26 mod end */
...
/* FUJITSU:2013-03-26 add start */
	int value = 0;
/* FUJITSU:2013-03-26 add end */
...
/* FUJITSU:2013-03-26 mod start */
		...
		pr_info("%s:CHECK_FOR_BOOT getting MDM2AP_STATUS %d\n", __func__, value);
		if (value == 0)
#else
		if (gpio_get_value(mdm_drv->mdm2ap_status_gpio) == 0)
#endif
...
#if 1
		value = gpio_get_value(mdm_drv->mdm2ap_status_gpio);
		pr_info("%s:NORMAL_BOOT_DONE getting MDM2AP_STATUS %d\n", __func__, value);
		if (!status && value == 0)
#else
...
/* FUJITSU:2013-03-26 mod start */
		...
		pr_info("%s:GET_DLOAD_STATUS getting MDM2AP_ERRFATAL %d\n", __func__, value);
		if (value == 1 &&
#else
...
/* FUJITSU:2013-03-26 add start */
static void dump_mdm_gpio(struct mdm_device *mdev)
{
	struct mdm_modem_drv *mdm_drv = &mdev->mdm_data;
	struct mdm_vddmin_resource *vddmin_res = mdev->mdm_data.pdata->vddmin_resource;
	int value = 0;

	if (vddmin_res) {
		value = gpio_get_value(vddmin_res->mdm2ap_vddmin_gpio);
		pr_info("%s: MDM2AP_VDDMIN %d\n", __func__, value);

		value = gpio_get_value(vddmin_res->ap2mdm_vddmin_gpio);
		pr_info("%s: AP2MDM_VDDMIN %d\n", __func__, value);
	} else {
		pr_info("%s: MDM2AP_VDDMIN null\n", __func__);
		pr_info("%s: AP2MDM_VDDMIN null\n", __func__);
	}

	value = gpio_get_value(mdm_drv->mdm2ap_errfatal_gpio);
	pr_info("%s: MDM2AP_ERRFATAL %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->ap2mdm_errfatal_gpio);
	pr_info("%s: AP2MDM_ERRFATAL %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->mdm2ap_status_gpio);
	pr_info("%s: MDM2AP_STATUS %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->ap2mdm_status_gpio);
	pr_info("%s: AP2MDM_STATUS %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->mdm2ap_wakeup_gpio);
	pr_info("%s: MDM2AP_WAKEUP %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->ap2mdm_wakeup_gpio);
	pr_info("%s: AP2MDM_WAKEUP %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->ap2mdm_soft_reset_gpio);
	pr_info("%s: AP2MDM_SOFT_RESET %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->ap2mdm_kpdpwr_n_gpio);
	pr_info("%s: AP2MDM_KPDPWR_N %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->ap2mdm_pmic_pwr_en_gpio);
	pr_info("%s: AP2MDM_PMIC_PWR_EN %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->mdm2ap_pblrdy);
	pr_info("%s: MDM2AP_PBLRDY %d\n", __func__, value);

	value = gpio_get_value(mdm_drv->usb_switch_gpio);
	pr_info("%s: USB_SW %d\n", __func__, value);
}
/* FUJITSU:2013-03-26 add end */
				...
				unsigned long event, void *ptr)
{
	...
	/* FUJITSU:2013-02-20 message add start */
	pr_err("%s: setting AP2MDM_ERRFATAL high\n", __func__);
	/* FUJITSU:2013-02-20 message add end */
...
/* FUJITSU:2013-03-26 add start */
	pr_info("%s: setting AP2MDM_ERRFATAL low\n", __func__);
	pr_info("%s: setting AP2MDM_STATUS high\n", __func__);
/* FUJITSU:2013-03-26 add end */
...
/* FUJITSU:2013-03-26 add start */
	{
		pr_info("%s: setting AP2MDM_WAKEUP low\n", __func__);
/* FUJITSU:2013-03-26 add end */
...
/* FUJITSU:2013-03-26 add start */
	{
		pr_info("%s: setting AP2MDM_PMIC_PWR_EN high\n", __func__);
/* FUJITSU:2013-03-26 add end */
...
/* FUJITSU:2013-03-26 add start */
	{
		pr_info("%s: setting AP2MDM_PMIC_PWR_EN low\n", __func__);
/* FUJITSU:2013-03-26 add end */
