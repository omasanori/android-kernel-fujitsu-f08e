...
/* FUJITSU:2012-11-16 13-1st add start */
#define APQ_8064_GSBI2_QUP_I2C_BUS_ID 2
/* FUJITSU:2012-11-16 13-1st add end */
...
/* FUJITSU:2012-11-16 GPIO_Expander add start */
#define BU1852_EXP1_GPIO_BASE	(SX150X_EXP4_GPIO_BASE + SX150X_EXP4_NR_GPIOS)
#define BU1852_EXP1_NR_GPIOS	20

#define BU1852_EXP2_GPIO_BASE	(BU1852_EXP1_GPIO_BASE + BU1852_EXP1_NR_GPIOS)
#define BU1852_EXP2_NR_GPIOS	20
/* FUJITSU:2012-11-16 GPIO_Expander add end */

/* FUJITSU:2012-12-21 GPIO_Expander add start */
#define BU1852_EXP1_GPIO_TO_SYS(exp1_gpio)	(exp1_gpio + BU1852_EXP1_GPIO_BASE)
#define BU1852_EXP2_GPIO_TO_SYS(exp2_gpio)	(exp2_gpio + BU1852_EXP2_GPIO_BASE)
/* FUJITSU:2012-12-21 GPIO_Expander add end */
