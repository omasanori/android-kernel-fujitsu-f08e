...
/* FUJITSU:2013-02-18 add start */
extern int charging_mode;
/* FUJITSU:2013-02-18 add end */
...
/* FUJITSU:2013-03-26 add start */
	pr_info("%s: setting AP2MDM_SOFT_RESET %d\n", __func__, soft_reset_direction_assert);
/* FUJITSU:2013-03-26 add end */
	...
	mdelay(10);
/* FUJITSU:2013-03-26 add start */
	pr_info("%s: setting AP2MDM_SOFT_RESET %d\n", __func__, soft_reset_direction_de_assert);
/* FUJITSU:2013-03-26 add end */
	gpio_direction_output(mdm_drv->ap2mdm_soft_reset_gpio,
...
{
/* FUJITSU:2013-02-18 mod start */
#if 1
	int i = 0;
#else
	int i;
#endif
/* FUJITSU:2013-02-18 mod end */
...
/* FUJITSU:2013-03-26 add start */
		{
			pr_info("%s: setting AP2MDM_WAKEUP high\n", __func__);
/* FUJITSU:2013-03-26 add end */
