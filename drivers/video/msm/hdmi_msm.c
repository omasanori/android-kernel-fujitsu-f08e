...
#undef DEV_DBG
#ifdef DEBUG
#define DEV_DBG(args...)	printk(DEV_DBG_PREFIX args)
#else
#define DEV_DBG(args...)	printk(DEV_DBG_PREFIX args)
//#define DEV_DBG(args...)	{if (makercmd_mode) { dev_info(external_common_state->dev, args); } else { dev_info(external_common_state->dev, "%d\n", __LINE__); }}
#endif /* DEBUG */
#undef DEV_INFO
#define DEV_INFO printk
...
static void hdmi_msm_send_event(boolean on)
{
	...
	if (on) {
		...
		if (!makercmd_mode) { // Aboid to run external_hwc in MC mode.
...
static void hdmi_msm_hdcp_enable(void)
{
	...
	if (hdmi_msm_state->reauth == FALSE) {
		msleep(1000);
	}
...
/*	480p60	480i60	576p50	576i50	720p60	 720p50	1080p60	1080i60	1080p50	1080i50	1080p24	1080p30	1080p25	640x480p 480p60_16_9 576p50_4_3 1280x1024p60_5_4 */
	/* Data Byte 01: 0 Y1 Y0 A0 B1 B0 S1 S0 */
	{0x10,	0x10,	0x10,	0x10,	0x10,	 0x10,	0x10,	0x10,	0x10,	 0x10,	0x10,	0x10,	0x10,	0x10, 0x10, 0x10, 0x10}, /*00*/
	/* Data Byte 02: C1 C0 M1 M0 R3 R2 R1 R0 */
	{0x18,	0x18,	0x28,	0x28,	0x28,	 0x28,	0x28,	0x28,	0x28,	 0x28,	0x28,	0x28,	0x28,	0x18, 0x28, 0x18, 0x08}, /*01*/
	/* Data Byte 03: ITC EC2 EC1 EC0 Q1 Q0 SC1 SC0 */
	{0x00,	0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	0x88, 0x00, 0x00, 0x04}, /*02 Packet Types if bit 7 of bytes PB1, PB4, or any of the bits [7:2] of byte PB3, or any of the bits [7:4] of byte PB5 is not equal 0b0, then FAIL. */
	/* Data Byte 04: 0 VIC6 VIC5 VIC4 VIC3 VIC2 VIC1 VIC0 */
	{0x02,	0x06,	0x12,	0x15,	0x04,	 0x13,	0x10,	0x05,	0x1F,	 0x14,	0x20,	0x22,	0x21,	0x01, 0x03, 0x11, 0x00}, /*03 576p VIC bit Fix 0x11 -> 0x12*/
	/* Data Byte 05: 0 0 0 0 PR3 PR2 PR1 PR0 */
	{0x00,	0x01,	0x00,	0x01,	0x00,	 0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	0x40, 0x00, 0x00, 0x00}, /*04 Video Quantization 640x480p 0x00->0x40 */
	/* Data Byte 06: LSB Line No of End of Top Bar */
	{0x00,	0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	0x00, 0x00, 0x00, 0x00}, /*05*/
	/* Data Byte 07: MSB Line No of End of Top Bar */
	{0x00,	0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	0x00, 0x00, 0x00, 0x00}, /*06*/
	/* Data Byte 08: LSB Line No of Start of Bottom Bar */
	{0xE1,	0xE1,	0x41,	0x41,	0xD1,	 0xd1,	0x39,	0x39,	0x39,	 0x39,	0x39,	0x39,	0x39,	0xe1, 0xE1, 0x41, 0x01}, /*07*/
	/* Data Byte 09: MSB Line No of Start of Bottom Bar */
	{0x01,	0x01,	0x02,	0x02,	0x02,	 0x02,	0x04,	0x04,	0x04,	 0x04,	0x04,	0x04,	0x04,	0x01, 0x01, 0x02, 0x04}, /*08*/
	/* Data Byte 10: LSB Pixel Number of End of Left Bar */
	{0x00,	0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	 0x00,	0x00,	0x00,	0x00,	0x00, 0x00, 0x00, 0x00}, /*09*/
	...
	{0xD1,	0xD1,	0xD1,	0xD1,	0x01,	 0x01,	0x81,	0x81,	0x81,	 0x81,	0x81,	0x81,	0x81,	0x81, 0xD1, 0xD1, 0x01}, /*11*/
	/* Data Byte 13: MSB Pixel Number of Start of Right Bar */
	{0x02,	0x02,	0x02,	0x02,	0x05,	 0x05,	0x07,	0x07,	0x07,	 0x07,	0x07,	0x07,	0x07,	0x02, 0x02, 0x02, 0x05}  /*12*/
