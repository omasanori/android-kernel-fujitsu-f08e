...
/* FUJITSU:2012-11-19 DISP add LCD custom seq start */
void (*after_video_on)(void) = NULL;
/* FUJITSU:2012-11-19 DISP add LCD custom seq end   */
...
/* FUJITSU:2012-11-19 DISP add LCD custom seq start */
        if (after_video_on != NULL) after_video_on();
/* FUJITSU:2012-11-19 DISP add LCD custom seq end   */
		dsi_video_enabled = 1;
	}
}
...
/* FUJITSU:2012-11-19 DISP del video_start start */
//	mdp4_overlay_dsi_video_start();
    printk("########### %s vstart disable\n",__func__);
/* FUJITSU:2012-11-19 DISP del video_start end */
	mutex_unlock(&mfd->dma->ov_mutex);
...
/* FUJITSU:2012-11-19 DISP add LCD custom seq start */
void (*before_video_off)(void) = NULL;
/* FUJITSU:2012-11-19 DISP add LCD custom seq end */
...
/* FUJITSU:2012-11-19 DISP add LCD custom seq start */
    if (before_video_off != NULL) before_video_off();
/* FUJITSU:2012-11-19 DISP add LCD custom seq end   */
