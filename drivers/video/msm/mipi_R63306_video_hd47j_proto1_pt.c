...
static void mipi_r63306_video_hd47j_proto1_panel_display_on(void)
{
    int sent_cmds;
...
static void mipi_r63306_video_hd47j_proto1_panel_display_off(void)
{
    int sent_cmds;
...
static int mipi_r63306_video_hd47j_proto1_lcd_on(struct platform_device *pdev)
{
...
static int mipi_r63306_video_hd47j_proto1_lcd_off(struct platform_device *pdev)
{
    printk(KERN_INFO "[LCD]%s enter\n",__func__);
...
static char *mipi_r63306_video_hd47j_proto1_panel_name(void)
{
	return "";
}
...
static struct r63311_ctrl_funcs pfuncs = {
    .on_fnc               = mipi_r63306_video_hd47j_proto1_lcd_on,
    .off_fnc              = mipi_r63306_video_hd47j_proto1_lcd_off,
    .after_video_on_fnc   = mipi_r63306_video_hd47j_proto1_panel_display_on,
    .before_video_off_fnc = mipi_r63306_video_hd47j_proto1_panel_display_off,
/* FUJITSU:2013-04-08 DISP panel name start */
    .name_fnc             = mipi_r63306_video_hd47j_proto1_panel_name,
/* FUJITSU:2013-04-08 DISP panel name end */
};

static int mipi_video_r63306_hd47j_proto1_pt_init(void)
{
    int ret;

    printk(KERN_INFO "[LCD]%s enter\n",__func__);

	if (msm_fb_detect_client("mipi_r63306_video_proto1_hd47j"))
		return 0;
...
module_init(mipi_video_r63306_hd47j_proto1_pt_init);
