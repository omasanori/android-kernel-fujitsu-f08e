...
/* DSIPHY_TIMING_CTRL */
.timing = { 0xE7, 0x39, 0x27,
0, /* DSIPHY_TIMING_CTRL_3 = 0 */
0x6A, 0x71, 0x2C, 0x3C, 0x41, 0x03, 0x04}, 
...
#if 0
    {DTYPE_GEN_LWRITE, 1, 0, 0,   1, sizeof(cmd_internal_power_setting2), cmd_internal_power_setting2},
    {DTYPE_GEN_LWRITE, 1, 0, 0,   1, sizeof(cmd_internal_power_setting2), cmd_internal_power_setting2},
#endif
    {DTYPE_GEN_LWRITE, 1, 0, 0,   0, sizeof(cmd_test), cmd_test},
    {DTYPE_GEN_LWRITE, 1, 0, 0,   0, sizeof(cmd_seq_ctrl), cmd_seq_ctrl},
    {DTYPE_GEN_LWRITE, 1, 0, 0,   0, sizeof(cmd_nvm_load_ctrl), cmd_nvm_load_ctrl},
};
...
static void mipi_r63311_video_fhd52j_panel_display_on(void)
{
    int sent_cmds;
...
static void mipi_r63311_video_fhd52j_panel_display_off(void)
{
    int sent_cmds;
...
static int mipi_r63311_video_fhd52j_lcd_on(struct platform_device *pdev)
{
...
static int mipi_r63311_video_fhd52j_lcd_off(struct platform_device *pdev)
{
    printk("[LCD]%s enter\n",__func__);
...
static char *mipi_r63311_video_fhd52j_panel_name(void)
{
	return "";
}
...
static struct r63311_ctrl_funcs pfuncs = {
    .on_fnc               = mipi_r63311_video_fhd52j_lcd_on,
    .off_fnc              = mipi_r63311_video_fhd52j_lcd_off,
    .after_video_on_fnc   = mipi_r63311_video_fhd52j_panel_display_on,
    .before_video_off_fnc = mipi_r63311_video_fhd52j_panel_display_off,
/* FUJITSU:2013-04-02 DISP panel name start */
    .name_fnc             = mipi_r63311_video_fhd52j_panel_name,
/* FUJITSU:2013-04-02 DISP panel name end */

};

static int mipi_r63311_video_fhd52j_pt_init(void)
{
    int ret;

    printk("[LCD]%s enter\n",__func__);

	if (msm_fb_detect_client("mipi_r63311_video_fhd52j"))
		return 0;
	...
	pinfo.lcdc.h_back_porch  = 104; /* set this value to multiple of 4 and greater than 4 */
    ...
    pinfo.actual_height = 114;
    pinfo.actual_width = 64;
...
module_init(mipi_r63311_video_fhd52j_pt_init);
