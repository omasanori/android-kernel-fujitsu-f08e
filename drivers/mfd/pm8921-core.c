...
/* FUJITSU:2013-01-23 test add start */
	/*   name	     pc_name	    ctrl   test   hpm_min */
	NLDO("test_8921_l1",      "test_8921_l1_pc",  0x0AE, 0x0AF, LDO_150),
	NLDO("test_8921_l2",      "test_8921_l2_pc",  0x0B0, 0x0B1, LDO_150),
	PLDO("test_8921_l3",      "test_8921_l3_pc",  0x0B2, 0x0B3, LDO_150),
	PLDO("test_8921_l4",      "test_8921_l4_pc",  0x0B4, 0x0B5, LDO_50),
	PLDO("test_8921_l5",      "test_8921_l5_pc",  0x0B6, 0x0B7, LDO_300),
	PLDO("test_8921_l6",      "test_8921_l6_pc",  0x0B8, 0x0B9, LDO_600),
	PLDO("test_8921_l7",      "test_8921_l7_pc",  0x0BA, 0x0BB, LDO_150),
	PLDO("test_8921_l8",      "test_8921_l8_pc",  0x0BC, 0x0BD, LDO_300),
	PLDO("test_8921_l9",      "test_8921_l9_pc",  0x0BE, 0x0BF, LDO_300),
	PLDO("test_8921_l10",     "test_8921_l10_pc", 0x0C0, 0x0C1, LDO_600),
	PLDO("test_8921_l11",     "test_8921_l11_pc", 0x0C2, 0x0C3, LDO_150),
	NLDO("test_8921_l12",     "test_8921_l12_pc", 0x0C4, 0x0C5, LDO_150),
	PLDO("test_8921_l14",     "test_8921_l14_pc", 0x0C8, 0x0C9, LDO_50),
	PLDO("test_8921_l15",     "test_8921_l15_pc", 0x0CA, 0x0CB, LDO_150),
	PLDO("test_8921_l16",     "test_8921_l16_pc", 0x0CC, 0x0CD, LDO_300),
	PLDO("test_8921_l17",     "test_8921_l17_pc", 0x0CE, 0x0CF, LDO_150),
	NLDO("test_8921_l18",     "test_8921_l18_pc", 0x0D0, 0x0D1, LDO_150),
	PLDO("test_8921_l21",     "test_8921_l21_pc", 0x0D6, 0x0D7, LDO_150),
	PLDO("test_8921_l22",     "test_8921_l22_pc", 0x0D8, 0x0D9, LDO_150),
	PLDO("test_8921_l23",     "test_8921_l23_pc", 0x0DA, 0x0DB, LDO_150),
	NLDO1200("test_8921_l24",		    0x0DC, 0x0DD, LDO_1200),
	NLDO1200("test_8921_l25",		    0x0DE, 0x0DF, LDO_1200),
	NLDO1200("test_8921_l26",		    0x0E0, 0x0E1, LDO_1200),
	NLDO1200("test_8921_l27",		    0x0E2, 0x0E3, LDO_1200),
	NLDO1200("test_8921_l28",		    0x0E4, 0x0E5, LDO_1200),
	PLDO("test_8921_l29",     "test_8921_l29_pc", 0x0E6, 0x0E7, LDO_150),

	/*   name	pc_name       ctrl   test2  clk    sleep  hpm_min */
	SMPS("test_8921_s1", "test_8921_s1_pc", 0x1D0, 0x1D5, 0x009, 0x1D2, SMPS_1500),
	SMPS("test_8921_s2", "test_8921_s2_pc", 0x1D8, 0x1DD, 0x00A, 0x1DA, SMPS_1500),
	SMPS("test_8921_s3", "test_8921_s3_pc", 0x1E0, 0x1E5, 0x00B, 0x1E2, SMPS_1500),
	SMPS("test_8921_s4", "test_8921_s4_pc", 0x1E8, 0x1ED, 0x011, 0x1EA, SMPS_1500),

	/*     name	  ctrl fts_cnfg1 pfm  pwr_cnfg  hpm_min */
	FTSMPS("test_8921_s5", 0x025, 0x02E, 0x026, 0x032, SMPS_2000),
	FTSMPS("test_8921_s6", 0x036, 0x03F, 0x037, 0x043, SMPS_2000),

	/*   name	pc_name       ctrl   test2  clk    sleep  hpm_min */
	SMPS("test_8921_s7", "test_8921_s7_pc", 0x1F0, 0x1F5, 0x012, 0x1F2, SMPS_1500),
	SMPS("test_8921_s8", "test_8921_s8_pc", 0x1F8, 0x1FD, 0x013, 0x1FA, SMPS_1500),

	/* name		       pc_name	       ctrl   test */
	VS("test_8921_lvs1",        "test_8921_lvs1_pc", 0x060, 0x061),
	VS300("test_8921_lvs2",		       0x062, 0x063),
	VS("test_8921_lvs3",        "test_8921_lvs3_pc", 0x064, 0x065),
	VS("test_8921_lvs4",        "test_8921_lvs4_pc", 0x066, 0x067),
	VS("test_8921_lvs5",        "test_8921_lvs5_pc", 0x068, 0x069),
	VS("test_8921_lvs6",        "test_8921_lvs6_pc", 0x06A, 0x06B),
	VS("test_8921_lvs7",        "test_8921_lvs7_pc", 0x06C, 0x06D),
	VS300("test_8921_usb_otg",		       0x06E, 0x06F),
	VS300("test_8921_hdmi_mvs",		       0x070, 0x071),
