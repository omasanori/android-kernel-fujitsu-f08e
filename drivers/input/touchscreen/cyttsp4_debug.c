...
/* FUJITSU:2013-05-01 HMW_TTDA_SAKU2_LOG mod start */
	_cyttsp4_ilog(dev, "%s=%s%s\n", "cyttsp4_OpModeData", pr_buf,
			total_size <= max ? "" : CY_PR_TRUNCATED);
/* FUJITSU:2013-05-01 HMW_TTDA_SAKU2_LOG del start */
}
...
static int cyttsp4_xy_worker(struct cyttsp4_debug_data *dd)
{
	...
	/* Interrupt */
	_cyttsp4_ilog(dev, "Interrupt(%u)\n", dd->interrupt_count);	/* FUJITSU:2013-05-01 HMW_TTDA_SAKU2_LOG mod */
	...
	_cyttsp4_ilog_str(dev, "\n");	/* FUJITSU:2013-05-01 HMW_TTDA_SAKU2_LOG mod */
