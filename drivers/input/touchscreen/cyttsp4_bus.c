...
/* FUJITSU:2013-05-28 HMW_TOUCH_OFFCHARGE_MODE add start */
extern int charging_mode;			/* OFF charger mode flag */
/* FUJITSU:2013-05-28 HMW_TOUCH_OFFCHARGE_MODE add end */
...
/* FUJITSU:2013-05-28 HMW_TOUCH_OFFCHARGE_MODE add start */
	if (charging_mode) {
		printk(KERN_DEBUG "%s: *** Do not start off charging mode ***\n", __func__);
		return -ENODEV;
	}
/* FUJITSU:2013-05-28 HMW_TOUCH_OFFCHARGE_MODE add end */
