...
/* FUJITSU:2013-06-06 HMW_TOUCH_P_ mod start */
#if 0
...
#endif
static void cyttsp4_input_report(struct input_dev *input, int sig, int t, int type)
{
	input_mt_slot(input, t);
	input_mt_report_slot_state(input, MT_TOOL_FINGER, true);
}
/* FUJITSU:2013-06-06 HMW_TOUCH_P_ mod end */
...
{
/* FUJITSU:2013-06-06 HMW_TOUCH_P_ del start */
#if 0
	input_set_abs_params(input, ABS_MT_TOOL_TYPE,
			0, MT_TOOL_MAX, 0, 0);
#endif
/* FUJITSU:2013-06-06 HMW_TOUCH_P_ del end */
