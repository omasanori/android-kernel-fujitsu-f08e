...
#ifndef _LINUX_CYTTSP4_IOCTL_H
#define _LINUX_CYTTSP4_IOCTL_H

#define CYTTSP4_IOCTL_NAME "cyttsp4_ioctl"
...
struct cyttsp4_ioctl_platform_data {
	char const *ioctl_dev_name;
};
...
enum {
	 CY_IC_TOUCHPOS_STS_IDLE		= (int)0	/* IDLE							*/
	,CY_IC_TOUCHPOS_STS_WORKING					/* doing collect position		*/
	,CY_IC_TOUCHPOS_STS_SUCCESS					/* Success collect position		*/
	,CY_IC_TOUCHPOS_STS_ERROREND				/* Error collect position		*/
};

struct cyttsp4_ioctl_touch_pos_info {
	atomic_t						atm_status;			/* CY_IC_TOUCHPOS_STS_xxxx */
	atomic_t						atm_curr_cnt;

	enum cyttsp4_information_state	press_info_sts;		/* CY_INFOSTATE_xxxx */

	u8								press_th_val;		/* CY_PRESS_THRESHOLD_STATUS read value */
	struct fj_touch_position_info	pos_info;
};
