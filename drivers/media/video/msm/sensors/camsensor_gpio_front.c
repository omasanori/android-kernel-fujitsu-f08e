...
//    for (cnt = 1000 * 2; cnt; cnt--) {
	for (cnt = 1000 * _I2C_FRONT_WAIT_; cnt; cnt--) {
        udelay(3);
...
===========================================================================*/
int camsensor_gpioi2c_front_write(struct camsensor_i2c_command *cmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t *pd;
...
===========================================================================*/
int camsensor_gpioi2c_front_read(struct camsensor_i2c_command *cmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t  *pd;
...
===========================================================================*/
int camsensor_gpioi2c_front_write_isp(struct camsensor_i2c_command_isp *cmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t  *pd;
...
===========================================================================*/
int camsensor_gpioi2c_front_read_isp(struct camsensor_i2c_command_isp *cmd)
{
    int rc = TRUE;
    uint16_t len;
    uint8_t  *pd;
...
/*===========================================================================
    FUNCTION      CAMSENSOR_GPIOI2C_READ_ISP
===========================================================================*/
int camsensor_i2c_front_read_isp(struct i2c_client* client, struct camsensor_i2c_command_isp* cmd)
{
...
/*===========================================================================
    FUNCTION      CAMSENSOR_GPIOI2C_WRITE_ISP
===========================================================================*/
int camsensor_i2c_front_write_isp(struct i2c_client* client, struct camsensor_i2c_command_isp* cmd)
{
...
/*===========================================================================
    FUNCTION      CAMSENSOR_GPIOI2C_READ
===========================================================================*/
int camsensor_i2c_front_read(struct i2c_client* client, struct camsensor_i2c_command* cmd)
{
...
/*===========================================================================
    FUNCTION      CAMSENSOR_GPIOI2C_WRITE
===========================================================================*/
int camsensor_i2c_front_write(struct i2c_client* client, struct camsensor_i2c_command* cmd)
{
