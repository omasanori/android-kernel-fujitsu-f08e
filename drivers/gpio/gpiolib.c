...
/* FUJITSU:2012-11-16 null check add start */
	if (chip == NULL) {
		pr_err("%s: chip is null gpio%d\n", __func__, gpio);
		return -1;
	}
/* FUJITSU:2012-11-16 null check add end */
...
/* FUJITSU:2012-11-16 GPIO Dump add start   */
void gpiolib_dbg_allgpio_out(int detail)
{
	//: show msm gpio.
	msm_gpio_dbg_out();
	//: show pmic gpio.
...
EXPORT_SYMBOL_GPL(gpiolib_dbg_allgpio_out);
/* FUJITSU:2012-11-16 GPIO Dump add start   */
