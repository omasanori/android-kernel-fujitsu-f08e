...
#include "host.h"
#include "sdio_bus.h"
/* FUJITSU:2012-07-21 SD Add start */
#ifdef CONFIG_MMC_PASSWORDS
#include "lock.h"
#endif
/* FUJITSU:2012-07-21 SD Add end */
...
/* FUJITSU:2013-01-23 SD mutex Add start */
#ifdef CONFIG_MMC_PASSWORDS
...
#endif
/* FUJITSU:2013-01-23 SD mutex Add end */
...
/* FUJITSU:2013-05-21 eMMC mod start */
/*		if (!card->ext_csd.raw_bkops_status)*/
		if (card->ext_csd.raw_bkops_status < 3)
			goto out;
/* FUJITSU:2013-05-21 eMMC mod end */
...
{
/* FUJITSU:2012-12-07 v4.5 is not supported. del start */
#if 0
	/*
	...
	if (card->ext_csd.feature_support & MMC_DISCARD_FEATURE)
		return 1;
#endif
/* FUJITSU:2012-12-07 v4.5 is not supported. del end */
	return 0;
}
...
/* FUJITSU:2013-01-23 SD mutex Add start */
#ifdef CONFIG_MMC_PASSWORDS
	if (check_device_id_sd(pdev->id) == true) {
...
/* FUJITSU:2013-02-04 SD Add start */
#ifdef CONFIG_MMC_PASSWORDS
	else if (check_device_id_sd(pdev->id) == true){
...
#endif
/* FUJITSU:2012-07-21 SD Add end (mmc_rescan() is copy) */
