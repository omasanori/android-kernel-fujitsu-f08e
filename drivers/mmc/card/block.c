...
/* FUJITSU:2012-08-24 add sdcc start */
#include <linux/pm_runtime.h>
#include <linux/platform_device.h>
/* FUJITSU:2012-08-24 add sdcc end */
...
/* FUJITSU 2012/06/26 : SD CHG Start */
//	/*
...
/* FUJITSU 2012/06/26 : SD CHG End */
	...
	if (!md) {
/* FUJITSU 2012-08-28 : SD CHG Start */
#if 0
		err = -EINVAL;
		goto cmd_done;
#else
		...
		return -EINVAL;
#endif
/* FUJITSU 2012-08-28 : SD CHG End */
	}

	card = md->queue.card;
/* FUJITSU:2013-03-25 SD CPRM start */
	if(card == NULL) {
		pr_err("%s: card=NULL\n",__func__);
		err = -EINVAL;
		goto cmd_done;
	}
/* FUJITSU:2013-03-25 SD CPRM end   */
	if (IS_ERR(card)) {
		err = PTR_ERR(card);
		goto cmd_done;
	}
